...
class Main_page(Base):
    ...
    def get_pizza_descr(self):
        return WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable(
            (By.XPATH, self.pizza_descr)))

    def get_pizza1_hover(self):
        return WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable(
            (By.XPATH, self.pizza1_hover)))

    def get_pizza2_hover(self):
        return WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable(
            (By.XPATH, self.pizza2_hover)))

    def get_pizza1_add_cart(self):
        return WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable(
            (By.XPATH, self.pizza1_add_cart)))

    def get_pizza2_add_cart(self):
        return WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable(
            (By.XPATH, self.pizza2_add_cart)))

    def get_left_slider(self):
        return WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable(
            (By.XPATH, self.left_slider)))

    def get_right_slider(self):
        return WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable(
            (By.XPATH, self.right_slider)))

    def get_go_cart(self):
        return WebDriverWait(self.driver, 15).until(EC.element_to_be_clickable(
            (By.XPATH, self.go_cart)))
