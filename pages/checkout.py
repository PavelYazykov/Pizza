...
class Checkout(Base):
    ...
    def get_surname(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.surname))
        )
    ...
    def get_postcode(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.postcode))
        )
    ...
    def get_agreement(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.agreement))
        )

    def get_order_date(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.order_date))
        )
