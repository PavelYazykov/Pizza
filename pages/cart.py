...
class Cart(Base):
    ...
    def get_quantity_field(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.quantity_field))
        )

    def get_pizza_1(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.LINK_TEXT, self.pizza_1))
        )

    def get_pizza_2(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.LINK_TEXT, self.pizza_2))
        )

    def get_pizza_3(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.LINK_TEXT, self.pizza_3))
        )

    def get_options(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.options))
        )

    def get_dessert(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.LINK_TEXT, self.dessert))
        )

    def get_del_pizza(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.del_pizza))
        )

    def get_order_button(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.order_button))
        )

    def get_promocode_field(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.promocode_field))
        )

    def get_cupon_button(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.cupon_button))
        )

    def get_cupon_apply_right(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.cupon_apply_right))
        )

    def get_cupon_apply_wrong(self):
        return WebDriverWait(self.driver, 15).until(
            EC.element_to_be_clickable((By.XPATH, self.cupon_apply_wrong))
        )
    ...
    def assert_cupon_right(self):
        with allure.step("Проверка применения верного промокода"):
            self.get_value(
                self.get_cupon_apply_right(), "Coupon code applied successfully."
            )
